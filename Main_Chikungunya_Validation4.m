% -----------------------------------------------------------------
%  Main_Chikungunya_Validation4.m
% -----------------------------------------------------------------
...
disp(' ------------------------------------------------------ ')
disp(' IMDC 2026                                              ')
disp(' Chikungunya - Validation Test 4                        ')
disp('                                                        ')
disp(' by                                                     ')
...
% -----------------------------------------------------------
case_name = 'IMDC2026_Chikungunya_Validation4';
...
% --- seasons 2014-2015 until 2023-2024 ---
nYearsTrain = 10;
...
FileNameCSV_inp = 'IMDC2026_AggregatedData-Chikungunya_';
 DirNameCSV_out = 'Chikungunya_Validation4_2025–2026-Season';
FileNameCSV_out = 'IMDC2026_Chikungunya_Validation4_';
% -----------------------------------------------------------
