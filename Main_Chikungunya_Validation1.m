% -----------------------------------------------------------------
%  Main_Chikungunya_Validation1.m
% -----------------------------------------------------------------
...
disp(' ------------------------------------------------------ ')
disp(' IMDC 2026                                              ')
disp(' Chikungunya - Validation Test 1                        ')
disp('                                                        ')
disp(' by                                                     ')
...
% -----------------------------------------------------------
case_name = 'IMDC2026_Chikungunya_Validation1';
...
% --- seasons 2014-2015 until 2020-2021 ---
nYearsTrain = 7;
...
FileNameCSV_inp = 'IMDC2026_AggregatedData-Chikungunya_';
 DirNameCSV_out = 'Chikungunya_Validation1_2022–2023-Season';
FileNameCSV_out = 'IMDC2026_Chikungunya_Validation1_';
% -----------------------------------------------------------
