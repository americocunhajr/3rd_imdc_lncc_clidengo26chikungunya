% -----------------------------------------------------------------
%  Main_Chikungunya_Validation2.m
% -----------------------------------------------------------------
...
disp(' ------------------------------------------------------ ')
disp(' IMDC 2026                                              ')
disp(' Chikungunya - Validation Test 2                        ')
disp('                                                        ')
disp(' by                                                     ')
...
% -----------------------------------------------------------
case_name = 'IMDC2026_Chikungunya_Validation2';
...
% --- seasons 2014-2015 until 2021-2022 ---
nYearsTrain = 8;
...
FileNameCSV_inp = 'IMDC2026_AggregatedData-Chikungunya_';
 DirNameCSV_out = 'Chikungunya_Validation2_2023–2024-Season';
FileNameCSV_out = 'IMDC2026_Chikungunya_Validation2_';
% -----------------------------------------------------------
