% -----------------------------------------------------------------
%  Main_Chikungunya_Validation3.m
% -----------------------------------------------------------------
%  This program runs a predictive model for Chikungunya outbreaks.
% -----------------------------------------------------------------
...
disp(' ------------------------------------------------------ ')
disp(' IMDC 2026                                              ')
disp(' Chikungunya - Validation Test 3                        ')
disp('                                                        ')
disp(' by                                                     ')
...
% -----------------------------------------------------------
case_name = 'IMDC2026_Chikungunya_Validation3';
...
% --- seasons 2014-2015 until 2022-2023 ---
nYearsTrain = 9;
...
% -----------------------------------------------------------
 DirNameCSV_inp = 'Data';
FileNameCSV_inp = 'IMDC2026_AggregatedData-Chikungunya_';
 DirNameCSV_out = 'Chikungunya_Validation3_2024–2025-Season';
FileNameCSV_out = 'IMDC2026_Chikungunya_Validation3_';
% -----------------------------------------------------------
